              ...
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span><span className="font-medium text-slate-800 group-hover:text-white">Dashboard</span></span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span><span className="font-medium text-slate-800 group-hover:text-white">Appointments</span> </span>
                  </Link>
                </li>
              </ul>
            </div>
